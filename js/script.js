...
let ulD = document.querySelector('.promo__interactive-list')
...
for (let item of movies) {
    ...
    let divDelete2 = document.createElement('div')
    let text2 = document.createElement('p')
    let li2 = document.createElement('li')
    let divDelete3 = document.createElement('div')
    let text3 = document.createElement('p')
    let li3 = document.createElement('li')
    let divDelete4 = document.createElement('div')
    let text4 = document.createElement('p')
    let li4 = document.createElement('li')
    let text5 = document.createElement('p')
    let divDelete5 = document.createElement('div')
    ...
    li4.classList.add('promo__interactive-item')


    text.innerHTML = item.Title

    body.append(ulD)
    ulD.append(li, li2, li3, li4)
    li.append(text, divDelete)
    li1.append(text2, divDelete2)
    li2.append(text3, divDelete3)
    li3.append(text4, divDelete4)
    li4.append(text5, divDelete5)
